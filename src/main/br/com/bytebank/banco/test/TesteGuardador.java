...
public class TesteGuardador {
	public static void main(String[] args) {
		...
		ContaCorrente cc1 = new ContaCorrente(new BigDecimal("526.5"), "10", "21540", c1);

		contas.adiciona(cc1);

		Cliente c2 = new Cliente("93219864512", "Ana Julia", LocalDate.of(2000, 01, 10), "Rua Carmine monetti");
		ContaPoupanca cp1 = new ContaPoupanca(new BigDecimal("856.5"), "11", "78540", c2);

		contas.adiciona(cp1);

		Cliente c3 = new Cliente("86919864512", "Diana Gimenes", LocalDate.of(2000, 01, 10), "Rua Jabuti");
		ContaCorrente cc2 = new ContaCorrente(new BigDecimal("786.5"), "10", "76540", c3);

		contas.adiciona(cc2);

		Cliente c4 = new Cliente("64378645182", "Vitoria Silva", LocalDate.of(2000, 01, 10), "Rua Caminhao");
		ContaPoupanca cp2 = new ContaPoupanca(new BigDecimal("5166.5"), "11", "658540", c4);
